          ...
          <div class="card-header pb-0 p-3">
            ...
            <?php
                ...
                foreach($reversed as $log)
                {
                    ...
                    echo '<h6 class="mb-0 text-sm">'. $c_item->name. ' | Updated: '. $c_item->update. '</h6>';
                    echo '<p style="font-size: 15px;">Old Price: '. $log->old_price. '</a></p>';
                    echo '<p style="font-size: 15px;">New Price: '. $log->new_price. '</a></p>';
                    echo '</div>';
                    echo '<a class="btn btn-link pe-3 ps-0 mb-0 ms-auto" href="#"><span style="align: center; right: 0;"class="badge bg-success rounded">- YoMarket Owner</span></a>';
                    echo '</li>';
                    echo '</div>';
                }
            ?>
