...
require_once("page_handlers/profile_h.php");
...
if(empty($profile_name)) {
  ...
  if($display_profile->type == ResponseType::REQ_FAILED || $display_profile->type == ResponseType::NONE)
          ...
          <div class="col-auto">
            ...
            <?php
                if(!empty($display_profile->results->yoworld_id)) {
                  echo '<img src="https://yomarket.info/page_handlers/cropped_avi_h.php?URL=https://yw-web.yoworld.com/user/images/yo_avatars/000/'. substr($display_profile->results->yoworld_id, 0, 3). "/". substr($display_profile->results->yoworld_id, 3, 3)."/". $display_profile->results->yoworld_id. '.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">';
                }
                ?>
            </div>
          </div>
            ...
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                ...
                <?php
                  ...
                  add_display_badges($display_profile);
            ...
            <div class="card-body p-3">
              <div style="width:100mw;height: 400px; line-height:.5em;padding:5px;overflow:auto;overflow-x:hidden;">
                <ul class="list-group">
                  ...
                  list_activities($display_profile);
                  ?>
                </ul>
              </div>
            </div>
